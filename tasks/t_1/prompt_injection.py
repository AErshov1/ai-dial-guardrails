...
def main():
    ...
    conversation.add_message(HumanMessage(content=get_user_profiles()))
    ...
    while True:
        ...
        response = azure_client.generate(messages=[conversation.get_history()])
        content = "\n".join([msg.text for msg in response.generations[0]])
        print("Assistant:", content)
        conversation.add_message(AIMessage(content=content))
